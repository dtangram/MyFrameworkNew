    ...
    <div class="container">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <base href="/">
          <a href="/crud/updateForm">Update New Fruit</a>
        </li>
      </ol>
          ...
          <form action="/crud/updateAction" method="post">
            <?php
              foreach($data["fruit"] as $fruit){
                echo "<input type='text' name='name' placeholder='Fruit Name' value='" . $fruit["name"] . "'>";
                echo "<input type='hidden' name='id' value='" . $fruit["id"] . "'>";
              }
            ?>
